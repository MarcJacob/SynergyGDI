...
:: Run final compile command.
%COMPILER% %CLIENT_SOURCES_PATH%SynergyClientMain.cpp /I%CLIENT_INCLUDES_PATH% /I%CLIENT_INCLUDES_PATH%\Public\ /I%CORE_INCLUDES_PATH% /Fe:%TARGET_PATH%%HotreloadableOutputFilename% /LDd /Zi